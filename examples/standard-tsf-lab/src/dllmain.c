...
DEFINE_GUID(CLSID_LabService, 0xc9921e99,0xd237,0x4692,0x81,0xb8,0x93,0xa8,0xf8,0x67,0x55,0x55);
DEFINE_GUID(GUID_LabProfile,  0xb8debf6e,0x4888,0x48f8,0xa9,0x14,0x5d,0x15,0xfb,0x55,0x94,0xbd);
#elif defined(LAB_AKEL_META_R3_READING_BUILD)
DEFINE_GUID(CLSID_LabService, 0x18acab1d,0x7f3a,0x41fb,0x98,0x08,0x21,0x40,0xb9,0x5c,0x45,0xec);
DEFINE_GUID(GUID_LabProfile,  0x2c9405a9,0xcfe5,0x4c8c,0x9a,0x30,0x61,0xb4,0xdb,0xfd,0xf7,0xd5);
#elif defined(LAB_AKEL_META_R3_LANGID_READING_BUILD)
DEFINE_GUID(CLSID_LabService, 0x6e2970a1,0x12a2,0x49fb,0xad,0xd2,0x73,0x1c,0x3a,0xff,0x81,0x2c);
DEFINE_GUID(GUID_LabProfile,  0x1b369386,0xaa7f,0x4c29,0x8e,0x42,0xf1,0xa8,0xe3,0x4b,0xa5,0xd3);
#elif defined(LAB_AKEL_META_R3_READING_LANGID_BUILD)
DEFINE_GUID(CLSID_LabService, 0xd3fd8812,0x99c8,0x483d,0xaa,0x1c,0x19,0x96,0xb6,0x54,0x4a,0xc8);
DEFINE_GUID(GUID_LabProfile,  0x13388684,0xa390,0x436c,0xbb,0x8b,0xc0,0x20,0x62,0xf8,0x90,0xd2);
#elif defined(LAB_AKEL_META_R3_LANGID_ONCE_READING_BUILD)
DEFINE_GUID(CLSID_LabService, 0x1fb87aac,0x0bac,0x4f30,0xb7,0xeb,0xb6,0x08,0x9c,0xfb,0x69,0x98);
DEFINE_GUID(GUID_LabProfile,  0xf310ac34,0x6561,0x4433,0x9f,0x8a,0x3e,0xde,0x20,0xb0,0xe0,0x44);
#elif defined(LAB_AKEL_META_R2_CONTROL_BUILD)
DEFINE_GUID(CLSID_LabService, 0xcb3c197f,0xa52a,0x49a8,0xa1,0x72,0x4a,0x5c,0x22,0x28,0xb1,0x47);
DEFINE_GUID(GUID_LabProfile,  0x2ec4e197,0x23eb,0x41ff,0x81,0x7f,0x40,0x7f,0x44,0x6e,0x10,0x38);
#elif defined(LAB_AKEL_META_R2_LANGID_BUILD)
DEFINE_GUID(CLSID_LabService, 0xaf145d5c,0x4942,0x4af9,0xa6,0x05,0x05,0x7f,0x76,0xaa,0xd2,0x0d);
DEFINE_GUID(GUID_LabProfile,  0xf09fa9d3,0xd754,0x4937,0xa8,0xf7,0x76,0x42,0x3a,0x09,0x0d,0xc8);
#elif defined(LAB_AKEL_META_R2_READING_BUILD)
DEFINE_GUID(CLSID_LabService, 0x8d7ff938,0x6c84,0x4c67,0x80,0xcf,0x32,0xf6,0xe9,0x31,0x66,0x18);
DEFINE_GUID(GUID_LabProfile,  0x00d4032f,0xdd2d,0x49cb,0xb9,0xf2,0x16,0x03,0x46,0x11,0x96,0x81);
#elif defined(LAB_AKEL_META_R2_BOTH_BUILD)
DEFINE_GUID(CLSID_LabService, 0xd7b0bfea,0xb029,0x44ff,0xbe,0x52,0xb2,0x05,0x45,0x5d,0x10,0xcf);
DEFINE_GUID(GUID_LabProfile,  0xa10f4224,0xe251,0x4659,0x84,0xe9,0x93,0x36,0x2d,0x37,0x1d,0xd4);
