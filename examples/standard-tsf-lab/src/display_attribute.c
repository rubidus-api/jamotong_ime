...
const GUID GUID_LabDisplayAttributeInput =
    { 0xdd1802b0, 0x070a, 0x469c, { 0xb8, 0xf5, 0x5e, 0xf5, 0x13, 0xd9, 0x1e, 0xf8 } };
#elif defined(LAB_AKEL_META_R3_READING_LANGID_BUILD)
const GUID GUID_LabDisplayAttributeInput =
    { 0x2cec5389, 0x4c68, 0x4e61, { 0xaa, 0xc0, 0x03, 0x81, 0x07, 0x03, 0x02, 0xff } };
#elif defined(LAB_AKEL_META_R3_LANGID_ONCE_READING_BUILD)
const GUID GUID_LabDisplayAttributeInput =
    { 0xba00c0b7, 0x1e4a, 0x43e2, { 0x96, 0xcb, 0xef, 0xd0, 0x3c, 0x55, 0xb8, 0x13 } };
