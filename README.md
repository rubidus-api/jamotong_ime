...
|---|---|
| **Jamotong installer** | **[jamotong-0.50.0.zip](https://github.com/rubidus-api/jamotong_ime/releases/download/v0.50.0/jamotong-0.50.0.zip)** — extract anywhere, run `install.bat` as administrator |
