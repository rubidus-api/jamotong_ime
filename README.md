...
|---|---|
| **Jamotong installer** | **[jamotong-0.27.1.zip](https://github.com/rubidus-api/jamotong_ime/releases/download/v0.27.1/jamotong-0.27.1.zip)** — extract to a permanent folder, run `install.bat` as administrator |
