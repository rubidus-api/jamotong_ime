...
|---|---|
| **Jamotong installer** | **[jamotong-0.49.3.zip](https://github.com/rubidus-api/jamotong_ime/releases/download/v0.49.3/jamotong-0.49.3.zip)** — extract anywhere, run `install.bat` as administrator |
