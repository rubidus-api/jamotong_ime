...
|---|---|
| **Jamotong installer** | **[jamotong-0.23.2.zip](https://github.com/rubidus-api/jamotong_ime/releases/download/v0.23.2/jamotong-0.23.2.zip)** — extract to a permanent folder, run `install.bat` as administrator |
