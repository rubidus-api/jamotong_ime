...
|---|---|
| **Jamotong installer** | **[jamotong-0.45.1.zip](https://github.com/rubidus-api/jamotong_ime/releases/download/v0.45.1/jamotong-0.45.1.zip)** — extract anywhere, run `install.bat` as administrator |
...
| Japanese dictionary pack (demo) | [jamotong-japanese-demo-0.45.1.zip](https://github.com/rubidus-api/jamotong_ime/releases/download/v0.45.1/jamotong-japanese-demo-0.45.1.zip) — experimental Japanese input, 50,000 entries (~0.5 MB) |
| Japanese dictionary pack (full) | [jamotong-japanese-full-0.45.1.zip](https://github.com/rubidus-api/jamotong_ime/releases/download/v0.45.1/jamotong-japanese-full-0.45.1.zip) — the same, 500,000 entries (~5 MB) |
