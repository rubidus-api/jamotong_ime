...
|---|---|
| **Jamotong installer** | **[jamotong-0.27.0.zip](https://github.com/rubidus-api/jamotong_ime/releases/download/v0.27.0/jamotong-0.27.0.zip)** — extract to a permanent folder, run `install.bat` as administrator |
