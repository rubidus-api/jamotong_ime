...
|---|---|
| **Jamotong installer** | **[jamotong-0.24.0.zip](https://github.com/rubidus-api/jamotong_ime/releases/download/v0.24.0/jamotong-0.24.0.zip)** — extract to a permanent folder, run `install.bat` as administrator |
