...
|---|---|
| **Jamotong installer** | **[jamotong-0.23.6.zip](https://github.com/rubidus-api/jamotong_ime/releases/download/v0.23.6/jamotong-0.23.6.zip)** — extract to a permanent folder, run `install.bat` as administrator |
