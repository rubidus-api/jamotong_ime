...
| | 최신 릴리스 (클릭 = 바로 다운로드) |
|---|---|
| **자모통 설치판** | **[jamotong-0.45.1.zip](https://github.com/rubidus-api/jamotong_ime/releases/download/v0.45.1/jamotong-0.45.1.zip)** — 아무 곳에 풀고 `install.bat` 을 관리자 권한으로 실행 |
...
| 일본어 사전 팩 (시범) | [jamotong-japanese-demo-0.45.1.zip](https://github.com/rubidus-api/jamotong_ime/releases/download/v0.45.1/jamotong-japanese-demo-0.45.1.zip) — 시범 일본어 입력, 5만 항목(약 0.5MB) |
| 일본어 사전 팩 (추가) | [jamotong-japanese-full-0.45.1.zip](https://github.com/rubidus-api/jamotong_ime/releases/download/v0.45.1/jamotong-japanese-full-0.45.1.zip) — 같은 것, 50만 항목(약 5MB) |
