...
| | 최신 릴리스 (클릭 = 바로 다운로드) |
|---|---|
| **자모통 설치판** | **[jamotong-0.49.3.zip](https://github.com/rubidus-api/jamotong_ime/releases/download/v0.49.3/jamotong-0.49.3.zip)** — 아무 곳에 풀고 `install.bat` 을 관리자 권한으로 실행 |
