...
| | 최신 릴리스 (클릭 = 바로 다운로드) |
|---|---|
| **자모통 설치판** | **[jamotong-0.27.0.zip](https://github.com/rubidus-api/jamotong_ime/releases/download/v0.27.0/jamotong-0.27.0.zip)** — 압축을 영구 폴더에 풀고 `install.bat` 을 관리자 권한으로 실행 |
