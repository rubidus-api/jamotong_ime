...
APP_SRCS = src/tray_app.c src/config.c src/layout.c src/fsm.c src/hangul_layout.c \
           src/chord.c src/chord_layout.c src/klay.c src/plugin_loader.c src/settings_ui.c src/ui_server.c
